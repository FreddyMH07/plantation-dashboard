// File: js/ui.js
// Tugas: Hanya untuk membangun dan memperbarui elemen di halaman.
...
export function renderDailyDashboard(data, dailyTable) {
    ...
    const kpiHtml = `<div class="col-lg-3 col-md-6"><div class="kpi-box"><div class="title">ACV Production</div><div class="value"><span class="math-inline">\{data\.kpi\_acv\.value\}</div\></div\></div\><div class\="col\-lg\-9 col\-md\-6"\><div class\="card master\-data\-card h\-100"\><div class\="card\-body row text\-center align\-items\-center"\><div class\="col"\><div class\="title"\>SPH</div\><div class\="value"\></span>{data.master_data_display.sph}</div></div><div class="col"><div class="title">Luas TM (Ha)</div><div class="value"><span class="math-inline">\{data\.master\_data\_display\.luas\_tm\}</div\></div\><div class\="col"\><div class\="title"\>Pokok \(Pkk\)</div\><div class\="value"\></span>{data.master_data_display.pkk}</div></div><div class="col"><div class="title">Budget Bulan Ini</div><div class="value">${parseFloat(data.master_data_display.budget_monthly).toLocaleString('id-ID')}</div></div></div></div></div>`;
...
// Anda bisa menambahkan fungsi renderMonthlyDashboard di sini dengan pola yang sama
